...
PIPELINE_A_DIR = BASE_DIR / "version one"   # improved UNet
PIPELINE_B_DIR = BASE_DIR / "version two"   # second UNet

# Make sure Python can import from both folders
sys.path.insert(0, str(PIPELINE_A_DIR))
sys.path.insert(0, str(PIPELINE_B_DIR))

# -----------------------------
# Import pipelines
# -----------------------------
# PIPELINE A: improved UNet + coloured 3D (from version one/)
...
# PIPELINE B: second UNet + different style 3D (from version two/)
...
# -----------------------------
BASE_DIR   = Path(__file__).resolve().parent
UPLOAD_DIR = BASE_DIR /"web_outputs"/ "web_uploads"
PRED_DIR   = BASE_DIR /"web_outputs"/ "web_pred"
OUT_3D_DIR = BASE_DIR /"web_outputs"/ "web_out_3d"
...
if __name__ == "__main__":
    # Only run this in the reloader child process
